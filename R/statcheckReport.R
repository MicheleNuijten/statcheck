statcheckReport <- function(statcheckOutput,outputFileName,outputDir){
  ...
  statcheckReport_template <- system.file("rmd/statcheckReport_template.Rmd", package="statcheck")
  ...
  file.rename(from = paste(curDir,"statcheckReport_template.html",sep="/"),
