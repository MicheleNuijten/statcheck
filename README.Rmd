...
cat(
	...
	badge_cran_download("statcheck", "grand-total", "blue"),
	badge_github_version("MicheleNuijten/statcheck", "yellow")
)
```
<!-- badges: end -->
...
Also see [statcheck.io](http://statcheck.io/), a web-based interface for statcheck.
